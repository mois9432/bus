...
var GoUrl = `https://ptx.transportdata.tw/MOTC/v2/Bus/EstimatedTimeOfArrival/City/NewTaipei/${roadLine}?$filter=RouteName%2FZh_tw%20eq%20%27${roadLine}%27%20and%20Direction%20eq%20%270%27&$top=100&$format=JSON`;
// console.log(GoUrl);
var BackUrl = `https://ptx.transportdata.tw/MOTC/v2/Bus/EstimatedTimeOfArrival/City/NewTaipei/${roadLine}?$filter=RouteName%2FZh_tw%20eq%20%27${roadLine}%27%20and%20Direction%20eq%20%271%27&$top=100&$format=JSON`;
...
toolBox.innerHTML =
    `<div class="container">
        ...
        <a href="index.html" title="回到路線查詢頁面">
